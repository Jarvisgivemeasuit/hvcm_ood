...
def ResNet18Gram(pretrained=False, num_classes=10):
    return ResNetGram(BasicBlock, [2, 2, 2, 2], num_classes=num_classes)

def ResNet34Gram(pretrained=False, num_classes=10):
    return ResNetGram(BasicBlock, [3, 4, 6, 3], num_classes=num_classes)